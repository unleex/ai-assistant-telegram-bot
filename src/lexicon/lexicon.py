LEXICON_RU = {
    ...
    # /start
    "start_command":
    """Здравствуйте, это Евпатий. Для корректной работы, 
    попросите каждого пользователя группы написать что-нибудь, я вас так запомню. Для дополнительной информации отправьте /help.""",
    # / help
    "help_command":
